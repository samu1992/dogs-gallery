...
const BreedsDetail = (breed) => {
  ...
  return (
    <section className='flex p-2 flex-rom justify-center items-center w-4/5'>
      <div>
        <Image src={image} alt='hola' width={600} height={450} className='imagen-2 rounded-l-2xl' />
      </div>
      <div className='detalles flex p-4 flex-col justify-start h-full w-1/3 items-start gap-4 rounded-r-2xl text-white'>
